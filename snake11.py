...
# 1st food: easy to get
food = [center_line, center_column + 5]
...
while True:
    ...
    # Check whether food was found. if so: don't remove the tail
    if new_head == food:
        # spawn new food where no snake is at the moment
        food = None
        while food is None:
            new_food = [
